...
extern const char * const command_line_syntax___HELP_ARGS[2];
extern const char * const command_line_syntax___SPLIT_ARGS[2];
extern const char * const command_line_syntax___MERGE_ARGS[2];
